exports.config = {
    ...
    // from the same tests should run unit-tests.
    //
    maxInstances: 10,
    //
    ...
    // the wdio-sync package. If you still want to run your unit-tests in an async way
    ...
    coloredLogs: true,
    //
    // If you only want to run your unit-tests until a specific amount of unit-tests have failed use
    // bail (default is 0 - don't bail, run all unit-tests).
    bail: 0,
    //
    ...
    // the plugin installed before running any unit-tests. The following plugins are currently
    // available:
    ...
    // },
    /**
     * Gets executed after all unit-tests are done. You still have access to all global variables from
     * the tests.
